...
namespace CMS.Controllers
{
    ...
    */
    public class FeatureTypesController : ODataController
    {
        ...
        // GET: odata/FeatureTypes(5)/Feature
        [EnableQuery]
        public IQueryable<Feature> GetFeature([FromODataUri] Guid key)
        {
            return db.FeatureType.Where(m => m.Id == key).SelectMany(m => m.Feature);
        }
